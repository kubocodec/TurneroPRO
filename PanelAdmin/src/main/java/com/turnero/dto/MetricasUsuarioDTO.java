...
public class MetricasUsuarioDTO {
    ...
    public long getTotalTurnosAtendidos() { return totalTurnosAtendidos; }
    public void setTotalTurnosAtendidos(long totalTurnosAtendidos) { this.totalTurnosAtendidos = totalTurnosAtendidos; }
    ...
    public Map<String, Long> getDistribucionCalificaciones() { return distribucionCalificaciones; }
    public void setDistribucionCalificaciones(Map<String, Long> distribucionCalificaciones) { this.distribucionCalificaciones = distribucionCalificaciones; }
    public long getTotalRellamadas() { return totalRellamadas; }
    public void setTotalRellamadas(long totalRellamadas) { this.totalRellamadas = totalRellamadas; }
    public java.util.List<TurnoDetalleDTO> getDetalleTurnos() { return detalleTurnos; }
    public void setDetalleTurnos(java.util.List<TurnoDetalleDTO> detalleTurnos) { this.detalleTurnos = detalleTurnos; }
}
